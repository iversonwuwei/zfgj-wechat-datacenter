...
@Transactional
public class UsrUserService implements DataService<UsrUser> {
    ...
    @Override
    public String save(UsrUser entity,
                       UsrUser user) {
    ...
    @Override
    public String updateById(UsrUser entity,
                             UsrUser user) {
        if (null != user && null != entity) {
    ...
    @Override
    public List<UsrUser> findAll(String orderBy,
                                 Integer pageSize,
                                 Integer pageNo) {
        example = new UsrUserExample();
        criteria = example.createCriteria();
