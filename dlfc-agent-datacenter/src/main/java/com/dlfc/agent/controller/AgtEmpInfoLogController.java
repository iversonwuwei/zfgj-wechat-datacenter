...
@RestController
@RequestMapping("/wc/datas/agtEmpInfoLog")
public class AgtEmpInfoLogController {
    ...
    public String save(@RequestBody AgtEmpInfoLog entity,
    ...
    public String updateById(@RequestParam AgtEmpInfoLog entity,
                             @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    public AgtEmpInfoLog findById(@RequestParam String id) {
