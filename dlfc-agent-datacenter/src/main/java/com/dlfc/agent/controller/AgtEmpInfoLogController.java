...
@RestController
@RequestMapping("/agtEmpInfoLog")
public class AgtEmpInfoLogController {

    @Autowired
    @Qualifier("AgtEmpInfoLogService")
    ...
    String save(@RequestParam AgtEmpInfoLog entity,
    ...
    String updateById(@RequestParam AgtEmpInfoLog entity,
                      @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    AgtEmpInfoLog findById(@RequestParam String id) {
        return (AgtEmpInfoLog) service.findById(id);
    }

    @RequestMapping(value = "/findAll", method = RequestMethod.GET)
    List<AgtEmpInfoLog> findAll(@RequestParam(required = false) Integer pageSize,
