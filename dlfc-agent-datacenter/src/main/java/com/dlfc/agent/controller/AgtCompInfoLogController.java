...
@RestController
@RequestMapping("/wc/datas/agtCompInfoLog")
public class AgtCompInfoLogController {
    ...
    public String save(@RequestBody AgtCompInfoLog entity,
    ...
    public String updateById(@RequestParam AgtCompInfoLog entity,
                             @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    public AgtCompInfoLog findById(@RequestParam String id) {
