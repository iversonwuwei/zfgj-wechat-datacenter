...
public class AgtUsrCompLogInfoController {
    ...
    public String save(@RequestBody AgtUsrCompLogInfo entity,
    ...
    public String updateById(@RequestParam AgtUsrCompLogInfo entity,
                             @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    public AgtUsrCompLogInfo findById(@RequestParam String id) {
