...
@RestController
@RequestMapping("/wc/datas/agtCompInfo")
public class AgtCompInfoController {

    @Autowired
    @Qualifier("AgtCompInfoService")
    ...
    String save(@RequestParam AgtCompInfo entity,
    ...
    String updateById(@RequestParam AgtCompInfo entity,
                      @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    AgtCompInfo findById(@RequestParam String id) {
        return (AgtCompInfo) service.findById(id);
    }

    @RequestMapping(value = "/findAll", method = RequestMethod.GET)
    List<AgtCompInfo> findAll(@RequestParam(required = false) Integer pageSize,
