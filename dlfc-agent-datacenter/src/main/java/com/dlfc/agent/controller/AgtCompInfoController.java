...
public class AgtCompInfoController {
    ...
    public String save(@RequestBody AgtCompInfo entity,
    ...
    public String updateById(@RequestParam AgtCompInfo entity,
                             @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    public AgtCompInfo findById(@RequestParam String id) {
