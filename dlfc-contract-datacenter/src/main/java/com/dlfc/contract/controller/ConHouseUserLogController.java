...
public class ConHouseUserLogController {
    ...
    public String save(@RequestBody ConHouseUserLog entity,
    ...
    public String updateById(@RequestParam ConHouseUserLog entity,
                             @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    public ConHouseUserLog findById(@RequestParam String id) {
