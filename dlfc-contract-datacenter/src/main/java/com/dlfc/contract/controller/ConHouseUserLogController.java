...
@RestController
@RequestMapping("/wc/datas/conHouseUserLog")
public class ConHouseUserLogController {

    @Autowired
    @Qualifier("ConHouseUserLogService")
    ...
    String save(@RequestParam ConHouseUserLog entity,
    ...
    String updateById(@RequestParam ConHouseUserLog entity,
                      @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    ConHouseUserLog findById(@RequestParam String id) {
        return (ConHouseUserLog) service.findById(id);
    }

    @RequestMapping(value = "/findAll", method = RequestMethod.GET)
    List<ConHouseUserLog> findAll(@RequestParam(required = false) Integer pageSize,
