...
@RestController
@RequestMapping("/sysPermissionScope")
public class SysPermissionScopeController {
    ...
    String save(@RequestParam SysPermissionScope entity,
    ...
    String updateById(@RequestParam SysPermissionScope entity,
                      @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    SysPermissionScope findById(@RequestParam String id) {
        return (SysPermissionScope) service.findById(id);
    }

    @RequestMapping(value = "/findAll", method = RequestMethod.GET)
    List<SysPermissionScope> findAll(@RequestParam(required = false) Integer pageSize,
