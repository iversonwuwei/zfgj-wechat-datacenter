...
public class SysOfficeController {
    ...
    String save(@RequestParam SysOffice entity,
    ...
    String updateById(@RequestParam SysOffice entity,
                      @RequestParam UsrUser user) {
        return service.updateById(entity, user);
    }

    @RequestMapping(value = "/findById", method = RequestMethod.GET)
    SysOffice findById(@RequestParam String id) {
        return (SysOffice) service.findById(id);
    }

    @RequestMapping(value = "/findAll", method = RequestMethod.GET)
    List<SysOffice> findAll(@RequestParam(required = false) Integer pageSize,
