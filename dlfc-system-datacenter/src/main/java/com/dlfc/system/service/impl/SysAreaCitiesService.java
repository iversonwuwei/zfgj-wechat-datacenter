...
@Transactional
public class SysAreaCitiesService implements DataService<SysAreaCities> {
    ...
    @Override
    public int count() {
        example = new SysAreaCitiesExample();
    ...
    @Override
    public String save(SysAreaCities entity,
                       UsrUser user) {
    ...
    @Override
    public String updateById(SysAreaCities entity,
                             UsrUser user) {
        if (null != user && null != entity) {
    ...
    @Override
    public List<SysAreaCities> findAll(String orderBy,
                                      Integer pageSize,
                                      Integer pageNo) {
        example = new SysAreaCitiesExample();
        criteria = example.createCriteria();
